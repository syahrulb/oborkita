...
(function(a){var b=0,c=0,d=0,f=0,e="ontouchstart"in window||0<navigator.msMaxTouchPoints,l="onorientationchange"in window,g=!1,r=!1,u=!1,A=!1,x=!1,D="pointer",P="pointer",W=[],U=[],oa=[],X=[],E=[],ba=[],F=[],q=[],y=[],ca=[],ja=[],m={showScrollbar:function(b,c){b.scrollbarHide&&a("."+c).css({opacity:b.scrollbarOpacity,filter:"alpha(opacity:"+100*b.scrollbarOpacity+")"})},hideScrollbar:function(a,b,c,d,f,e,g,l,r,u){if(a.scrollbar&&a.scrollbarHide)for(var h=c;h<c+25;h++)b[b.length]=m.hideScrollbarIntervalTimer(10*
h,d[c],(c+24-h)/24,f,e,g,l,r,u,a)},hideScrollbarInterval:function(b,c,d,e,g,k,l,r,u){f=-1*b/y[r]*(g-k-l-e);m.setSliderOffset("."+d,f);a("."+d).css({opacity:u.scrollbarOpacity*c,filter:"alpha(opacity:"+u.scrollbarOpacity*c*100+")"})},slowScrollHorizontalInterval:function(b,c,d,e,g,k,l,r,u,A,H,N,Z,v,B,p,x,n,G){if(G.infiniteSlider){if(d<=-1*y[p]||d<=-1*ca[p]){var h=a(b).width();if(d<=-1*ca[p]){var C=-1*H[0];a(c).each(function(b){m.setSliderOffset(a(c)[b],C+x);b<N.length&&(N[b]=-1*C);C+=B[b]});d+=-1*
N[0];q[p]=-1*N[0]+x;y[p]=q[p]+h-k;F[p]=0}for(;d<=-1*y[p];){var z=0,t=m.getSliderOffset(a(c[0]),"x");a(c).each(function(a){m.getSliderOffset(this,"x")<t&&(t=m.getSliderOffset(this,"x"),z=a)});Z=q[p]+h;m.setSliderOffset(a(c)[z],Z);q[p]=-1*N[1]+x;y[p]=q[p]+h-k;N.splice(0,1);N.splice(N.length,0,-1*Z+x);F[p]++}}if(d>=-1*q[p]||0<=d){h=a(b).width();if(0<d)for(C=-1*H[0],a(c).each(function(b){m.setSliderOffset(a(c)[b],C+x);b<N.length&&(N[b]=-1*C);C+=B[b]}),d-=-1*N[0],q[p]=-1*N[0]+x,y[p]=q[p]+h-k,F[p]=v;0<
-1*N[0]-h+x;){var K=0,M=m.getSliderOffset(a(c[0]),"x");a(c).each(function(a){m.getSliderOffset(this,"x")>M&&(M=m.getSliderOffset(this,"x"),K=a)});Z=q[p]-B[K];m.setSliderOffset(a(c)[K],Z);N.splice(0,0,-1*Z+x);N.splice(N.length-1,1);q[p]=-1*N[0]+x;y[p]=q[p]+h-k;F[p]--;E[p]++}for(;d>-1*q[p];)K=0,M=m.getSliderOffset(a(c[0]),"x"),a(c).each(function(a){m.getSliderOffset(this,"x")>M&&(M=m.getSliderOffset(this,"x"),K=a)}),Z=q[p]-B[K],m.setSliderOffset(a(c)[K],Z),N.splice(0,0,-1*Z+x),N.splice(N.length-1,1),
q[p]=-1*N[0]+x,y[p]=q[p]+h-k,F[p]--}}H=!1;k=m.calcActiveOffset(G,d,N,k,F[p],v,A,p);Z=(k+F[p]+v)%v;G.infiniteSlider?Z!=ba[p]&&(H=!0):k!=E[p]&&(H=!0);if(H&&(v=new m.args("change",G,b,a(b).children(":eq("+Z+")"),Z,n),a(b).parent().data("args",v),""!=G.onSlideChange))G.onSlideChange(v);E[p]=k;ba[p]=Z;d=Math.floor(d);if(p!=a(b).parent().data("args").data.sliderNumber)return!0;m.setSliderOffset(b,d);G.scrollbar&&(f=Math.floor((-1*d-q[p]+x)/(y[p]-q[p]+x)*(l-r-g)),b=g-u,d>=-1*q[p]+x?(b=g-u- -1*f,m.setSliderOffset(a("."+
e),0)):(d<=-1*y[p]+1&&(b=l-r-u-f),m.setSliderOffset(a("."+e),f)),a("."+e).css({width:b+"px"}))},slowScrollHorizontal:function(b,c,d,f,e,k,g,l,r,u,x,N,A,v,B,p,D,n,G,J,Q){var h=m.getSliderOffset(b,"x");k=[];var C=0,z=25/1024*l;frictionCoefficient=Q.frictionCoefficient;elasticFrictionCoefficient=Q.elasticFrictionCoefficient;snapFrictionCoefficient=Q.snapFrictionCoefficient;e>Q.snapVelocityThreshold&&Q.snapToChildren&&!G?C=1:e<-1*Q.snapVelocityThreshold&&Q.snapToChildren&&!G&&(C=-1);e<-1*z?e=-1*z:e>z&&
(e=z);a(b)[0]!==a(n)[0]&&(C*=-1,e*=-2);n=F[B];if(Q.infiniteSlider)var t=q[B],K=y[B];G=[];z=[];for(var M=0;M<A.length;M++)G[M]=A[M],M<c.length&&(z[M]=m.getSliderOffset(a(c[M]),"x"));for(;1<e||-1>e;){e*=frictionCoefficient;h+=e;(h>-1*q[B]||h<-1*y[B])&&!Q.infiniteSlider&&(e*=elasticFrictionCoefficient,h+=e);if(Q.infiniteSlider){if(h<=-1*K){K=a(b).width();var H=0,S=z[0];for(M=0;M<z.length;M++)z[M]<S&&(S=z[M],H=M);M=t+K;z[H]=M;t=-1*G[1]+J;K=t+K-l;G.splice(0,1);G.splice(G.length,0,-1*M+J);n++}if(h>=-1*
t){K=a(b).width();H=0;S=z[0];for(M=0;M<z.length;M++)z[M]>S&&(S=z[M],H=M);M=t-v[H];z[H]=M;G.splice(0,0,-1*M+J);G.splice(G.length-1,1);t=-1*G[0]+J;K=t+K-l;n--}}k[k.length]=h}z=!1;e=m.calcActiveOffset(Q,h,G,l,n,D,E[B],B);t=(e+n+D)%D;Q.snapToChildren&&(Q.infiniteSlider?t!=ba[B]&&(z=!0):e!=E[B]&&(z=!0),0>C&&!z?(e++,e>=A.length&&!Q.infiniteSlider&&(e=A.length-1)):0<C&&!z&&(e--,0>e&&!Q.infiniteSlider&&(e=0)));if(Q.snapToChildren||(h>-1*q[B]||h<-1*y[B])&&!Q.infiniteSlider){(h>-1*q[B]||h<-1*y[B])&&!Q.infiniteSlider?
k.splice(0,k.length):(k.splice(.1*k.length,k.length),h=0<k.length?k[k.length-1]:h);for(;h<G[e]-.5||h>G[e]+.5;)h=(h-G[e])*snapFrictionCoefficient+G[e],k[k.length]=h;k[k.length]=G[e]}C=1;0!=k.length%2&&(C=0);for(h=0;h<d.length;h++)clearTimeout(d[h]);n=(e+n+D)%D;t=0;for(h=C;h<k.length;h+=2)if(h==C||1<Math.abs(k[h]-t)||h>=k.length-2)t=k[h],d[d.length]=m.slowScrollHorizontalIntervalTimer(10*h,b,c,k[h],f,g,l,r,u,x,e,N,A,p,D,v,B,J,n,Q);t=(e+F[B]+D)%D;""!=Q.onSlideComplete&&1<k.length&&(d[d.length]=m.onSlideCompleteTimer(10*
(h+1),Q,b,a(b).children(":eq("+t+")"),n,B));d[d.length]=m.updateBackfaceVisibilityTimer(10*(h+1),c,B,D,Q);X[B]=d;m.hideScrollbar(Q,d,h,k,f,g,l,u,x,B)},onSlideComplete:function(b,c,d,e,f){d=new m.args("complete",b,a(c),d,e,e);a(c).parent().data("args",d);if(""!=b.onSlideComplete)b.onSlideComplete(d)},getSliderOffset:function(b,c){c="x"==c?4:5;if(!g||r||u)b=parseInt(a(b).css("left"),10);else{for(var d=["-webkit-transform","-moz-transform","transform"],e,f=0;f<d.length;f++)if(void 0!=a(b).css(d[f])&&
0<a(b).css(d[f]).length){e=a(b).css(d[f]).split(",");break}b=void 0==e[c]?0:parseInt(e[c],10)}return b},setSliderOffset:function(b,c){c=parseInt(c,10);!g||r||u?a(b).css({left:c+"px"}):a(b).css({msTransform:"matrix(1,0,0,1,"+c+",0)",webkitTransform:"matrix(1,0,0,1,"+c+",0)",MozTransform:"matrix(1,0,0,1,"+c+",0)",transform:"matrix(1,0,0,1,"+c+",0)"})},setBrowserInfo:function(){null!=navigator.userAgent.match("WebKit")?(D="-webkit-grab",P="-webkit-grabbing"):null!=navigator.userAgent.match("Gecko")?
(x=!0,D="move",P="-moz-grabbing"):null!=navigator.userAgent.match("MSIE 7")?A=r=!0:null!=navigator.userAgent.match("MSIE 8")?A=u=!0:null!=navigator.userAgent.match("MSIE 9")&&(A=!0)},has3DTransform:function(){var b=!1,c=a("<div />").css({msTransform:"matrix(1,1,1,1,1,1)",webkitTransform:"matrix(1,1,1,1,1,1)",MozTransform:"matrix(1,1,1,1,1,1)",transform:"matrix(1,1,1,1,1,1)"});""==c.attr("style")?b=!1:x&&21<=parseInt(navigator.userAgent.split("/")[3],10)?b=!1:void 0!=c.attr("style")&&(b=!0);return b},
getSlideNumber:function(a,b,c){return(a-F[b]+c)%c},calcActiveOffset:function(a,b,c,d,e,f,g,l){e=!1;a=[];var h;b>c[0]&&(h=0);b<c[c.length-1]&&(h=f-1);for(f=0;f<c.length;f++)c[f]<=b&&c[f]>b-d&&(e||c[f]==b||(a[a.length]=c[f-1]),a[a.length]=c[f],e=!0);0==a.length&&(a[0]=c[c.length-1]);for(f=e=0;f<a.length;f++)g=Math.abs(b-a[f]),g<d&&(e=a[f],d=g);for(f=0;f<c.length;f++)e==c[f]&&(h=f);return h},changeSlide:function(b,c,d,e,f,g,l,r,u,q,x,A,D,v,B,p,y,n){m.autoSlidePause(v);for(var h=0;h<e.length;h++)clearTimeout(e[h]);
var C=Math.ceil(n.autoSlideTransTimer/10)+1,k=m.getSliderOffset(c,"x"),z=A[b];z-=k;var t=b-(E[v]+F[v]+p)%p;if(n.infiniteSlider){b=(b-F[v]+2*p)%p;h=!1;0==b&&2==p&&(b=p,A[b]=A[b-1]-a(d).eq(0).outerWidth(!0),h=!0);z=A[b];z-=k;var K=[A[b]-a(c).width(),A[b]+a(c).width()];h&&A.splice(A.length-1,1);for(h=0;h<K.length;h++)Math.abs(K[h]-k)<Math.abs(z)&&(z=K[h]-k)}0>z&&-1==t?z+=a(c).width():0<z&&1==t&&(z-=a(c).width());t=[];m.showScrollbar(n,f);for(h=0;h<=C;h++)K=h,K/=C,K--,K=k+z*(Math.pow(K,5)+1),t[t.length]=
K;C=(b+F[v]+p)%p;for(h=k=0;h<t.length;h++){if(0==h||1<Math.abs(t[h]-k)||h>=t.length-2)k=t[h],e[h]=m.slowScrollHorizontalIntervalTimer(10*(h+1),c,d,t[h],f,g,l,r,u,q,b,x,A,B,p,D,v,y,C,n);0==h&&""!=n.onSlideStart&&(z=(E[v]+F[v]+p)%p,n.onSlideStart(new m.args("start",n,c,a(c).children(":eq("+z+")"),z,b)))}k=!1;n.infiniteSlider?C!=ba[v]&&(k=!0):b!=E[v]&&(k=!0);k&&""!=n.onSlideComplete&&(e[e.length]=m.onSlideCompleteTimer(10*(h+1),n,c,a(c).children(":eq("+C+")"),C,v));X[v]=e;m.hideScrollbar(n,e,h,t,f,g,
l,u,q,v);m.autoSlide(c,d,e,f,g,l,r,u,q,x,A,D,v,B,p,y,n)},changeOffset:function(b,c,d,e,f,k,g,l,r,u,A,x,D,v,B,p,P,n){m.autoSlidePause(v);for(var h=0;h<e.length;h++)clearTimeout(e[h]);n.infiniteSlider||(b=b>-1*q[v]+P?-1*q[v]+P:b,b=b<-1*y[v]?-1*y[v]:b);var C=Math.ceil(n.autoSlideTransTimer/10)+1,z=m.getSliderOffset(c,"x");h=(m.calcActiveOffset(n,b,x,g,F,p,E[v],v)+F[v]+p)%p;var t=x.slice();if(n.snapToChildren&&!n.infiniteSlider)b=x[h];else if(n.infiniteSlider&&n.snapToChildren){for(;b>=t[0];)t.splice(0,
0,t[p-1]+a(c).width()),t.splice(p,1);for(;b<=t[p-1];)t.splice(p,0,t[0]-a(c).width()),t.splice(0,1);h=m.calcActiveOffset(n,b,t,g,F,p,E[v],v);b=t[h]}var K=b-z;b=[];m.showScrollbar(n,f);for(t=0;t<=C;t++){var M=t;M/=C;M--;M=z+K*(Math.pow(M,5)+1);b[b.length]=M}C=(h+F[v]+p)%p;for(t=z=0;t<b.length;t++){if(0==t||1<Math.abs(b[t]-z)||t>=b.length-2)z=b[t],e[t]=m.slowScrollHorizontalIntervalTimer(10*(t+1),c,d,b[t],f,k,g,l,r,u,h,A,x,B,p,D,v,P,C,n);0==t&&""!=n.onSlideStart&&(C=(E[v]+F[v]+p)%p,n.onSlideStart(new m.args("start",
n,c,a(c).children(":eq("+C+")"),C,h)))}z=!1;n.infiniteSlider?C!=ba[v]&&(z=!0):h!=E[v]&&(z=!0);z&&""!=n.onSlideComplete&&(e[e.length]=m.onSlideCompleteTimer(10*(t+1),n,c,a(c).children(":eq("+C+")"),C,v));X[v]=e;m.hideScrollbar(n,e,t,b,f,k,g,r,u,v);m.autoSlide(c,d,e,f,k,g,l,r,u,A,x,D,v,B,p,P,n)},autoSlide:function(a,b,c,d,e,f,g,l,r,u,A,x,q,v,D,p,y){if(!U[q].autoSlide)return!1;m.autoSlidePause(q);W[q]=setTimeout(function(){!y.infiniteSlider&&E[q]>A.length-1&&(E[q]-=D);m.changeSlide(E[q]+F[q]+1,a,b,c,
d,e,f,g,l,r,u,A,x,q,v,D,p,y);m.autoSlide(a,b,c,d,e,f,g,l,r,u,A,x,q,v,D,p,y)},y.autoSlideTimer+y.autoSlideTransTimer)},autoSlidePause:function(a){clearTimeout(W[a])},isUnselectable:function(b,c){return""!=c.unselectableSelector&&1==a(b).closest(c.unselectableSelector).length?!0:!1},slowScrollHorizontalIntervalTimer:function(a,b,c,d,e,f,g,l,r,u,q,A,x,v,D,p,y,n,P,E){return setTimeout(function(){m.slowScrollHorizontalInterval(b,c,d,e,f,g,l,r,u,q,A,x,v,D,p,y,n,P,E)},a)},onSlideCompleteTimer:function(a,
b,c,d,e,f){return setTimeout(function(){m.onSlideComplete(b,c,d,e,f)},a)},hideScrollbarIntervalTimer:function(a,b,c,d,e,f,g,l,r,u){return setTimeout(function(){m.hideScrollbarInterval(b,c,d,e,f,g,l,r,u)},a)},updateBackfaceVisibilityTimer:function(a,b,c,d,e){return setTimeout(function(){m.updateBackfaceVisibility(b,c,d,e)},a)},updateBackfaceVisibility:function(b,c,d,e){c=(E[c]+F[c]+d)%d;for(var h=[],f=0;f<2*e.hardwareAccelBuffer;f++){var g=m.mod(c+f-e.hardwareAccelBuffer,d);if("visible"==a(b).eq(g).css("-webkit-backface-visibility")){h[h.length]=
...
onSliderLoaded:"",onSliderUpdate:"",onSliderResize:"",onSlideStart:"",onSlideChange:"",onSlideComplete:""},t);void 0==K&&(K=this);return a(K).each(function(g){function C(){m.autoSlidePause(k);ya=a(L).find("a");Da=a(L).find("[onclick]");ra=a(L).find("*");a(G).css("width","");a(G).css("height","");a(L).css("width","");I=a(L).children().not("script").get();na=[];R=[];h.responsiveSlides&&a(I).css("width","100%");y[k]=0;w=[];p=a(G).parent().width();J=a(G).outerWidth(!0);h.responsiveSlideContainer&&(J=
a(G).outerWidth(!0)>p?p:a(G).width());a(G).css({position:h.stageCSS.position,top:h.stageCSS.top,left:h.stageCSS.left,overflow:h.stageCSS.overflow,zIndex:h.stageCSS.zIndex,webkitPerspective:1E3,webkitBackfaceVisibility:"hidden",msTouchAction:"pan-y",width:J});a(h.unselectableSelector).css({cursor:"default"});for(var b=0;b<I.length;b++){na[b]=a(I[b]).width();R[b]=a(I[b]).outerWidth(!0);var c=R[b];h.responsiveSlides&&(R[b]>J?(c=J+-1*(R[b]-na[b]),na[b]=c,R[b]=J):c=na[b],a(I[b]).css({width:c}));a(I[b]).css({overflow:"hidden",
position:"absolute"});w[b]=-1*y[k];y[k]=y[k]+c+(R[b]-na[b])}h.snapSlideCenter&&(n=.5*(J-R[0]),h.responsiveSlides&&R[0]>J&&(n=0));ca[k]=2*y[k];for(b=0;b<I.length;b++)m.setSliderOffset(a(I[b]),-1*w[b]+y[k]+n),w[b]-=y[k];if(!h.infiniteSlider&&!h.snapSlideCenter){for(b=0;b<w.length&&!(w[b]<=-1*(2*y[k]-J));b++)Ea=b;w.splice(Ea+1,w.length);w[w.length]=-1*(2*y[k]-J)}for(b=0;b<w.length;b++)Y[b]=w[b];wa&&(U[k].startAtSlide=U[k].startAtSlide>w.length?w.length:U[k].startAtSlide,h.infiniteSlider?(U[k].startAtSlide=
(U[k].startAtSlide-1+O)%O,E[k]=U[k].startAtSlide):(U[k].startAtSlide=0>U[k].startAtSlide-1?w.length-1:U[k].startAtSlide,E[k]=U[k].startAtSlide-1),ba[k]=E[k]);q[k]=y[k]+n;a(L).css({position:"relative",cursor:D,webkitPerspective:"0",webkitBackfaceVisibility:"hidden",width:y[k]+"px"});fa=y[k];y[k]=2*y[k]-J+2*n;(ha=fa+n<J||0==J?!0:!1)&&a(L).css({cursor:"default"});va=a(G).parent().outerHeight(!0);Q=a(G).height();h.responsiveSlideContainer&&(Q=Q>va?va:Q);a(G).css({height:Q});m.setSliderOffset(L,w[E[k]]);
if(h.infiniteSlider&&!ha){b=m.getSliderOffset(a(L),"x");for(c=(F[k]+O)%O*-1;0>c;){var d=0,e=m.getSliderOffset(a(I[0]),"x");a(I).each(function(a){m.getSliderOffset(this,"x")<e&&(e=m.getSliderOffset(this,"x"),d=a)});var f=q[k]+fa;m.setSliderOffset(a(I)[d],f);q[k]=-1*w[1]+n;y[k]=q[k]+fa-J;w.splice(0,1);w.splice(w.length,0,-1*f+n);c++}for(;0<-1*w[0]-fa+n&&h.snapSlideCenter&&wa;){var g=0,C=m.getSliderOffset(a(I[0]),"x");a(I).each(function(a){m.getSliderOffset(this,"x")>C&&(C=m.getSliderOffset(this,"x"),
g=a)});f=q[k]-R[g];m.setSliderOffset(a(I)[g],f);w.splice(0,0,-1*f+n);w.splice(w.length-1,1);q[k]=-1*w[0]+n;y[k]=q[k]+fa-J;F[k]--;E[k]++}for(;b<=-1*y[k];)d=0,e=m.getSliderOffset(a(I[0]),"x"),a(I).each(function(a){m.getSliderOffset(this,"x")<e&&(e=m.getSliderOffset(this,"x"),d=a)}),f=q[k]+fa,m.setSliderOffset(a(I)[d],f),q[k]=-1*w[1]+n,y[k]=q[k]+fa-J,w.splice(0,1),w.splice(w.length,0,-1*f+n),F[k]++,E[k]--}m.setSliderOffset(L,w[E[k]]);m.updateBackfaceVisibility(I,k,O,h);h.desktopClickDrag||a(L).css({cursor:"default"});
h.scrollbar&&(a("."+S).css({margin:h.scrollbarMargin,overflow:"hidden",display:"none"}),a("."+S+" ."+H).css({border:h.scrollbarBorder}),T=parseInt(a("."+S).css("marginLeft"))+parseInt(a("."+S).css("marginRight")),V=parseInt(a("."+S+" ."+H).css("borderLeftWidth"),10)+parseInt(a("."+S+" ."+H).css("borderRightWidth"),10),v=""!=h.scrollbarContainer?a(h.scrollbarContainer).width():J,B=J/fa*(v-T),h.scrollbarHide||(xa=h.scrollbarOpacity),a("."+S).css({position:"absolute",left:0,width:v-T+"px",margin:h.scrollbarMargin}),
"top"==h.scrollbarLocation?a("."+S).css("top","0"):a("."+S).css("bottom","0"),a("."+S+" ."+H).css({borderRadius:h.scrollbarBorderRadius,background:h.scrollbarBackground,height:h.scrollbarHeight,width:B-V+"px",minWidth:h.scrollbarHeight,border:h.scrollbarBorder,webkitPerspective:1E3,webkitBackfaceVisibility:"hidden",position:"relative",opacity:xa,filter:"alpha(opacity:"+100*xa+")",boxShadow:h.scrollbarShadow}),m.setSliderOffset(a("."+S+" ."+H),Math.floor((-1*w[E[k]]-q[k]+n)/(y[k]-q[k]+n)*(v-T-B))),
a("."+S).css({display:"block"}),N=a("."+S+" ."+H),W=a("."+S));h.scrollbarDrag&&!ha&&a("."+S+" ."+H).css({cursor:D});h.infiniteSlider&&(aa=(y[k]+J)/3);""!=h.navSlideSelector&&a(h.navSlideSelector).each(function(b){a(this).css({cursor:"pointer"});a(this).unbind(ea).bind(ea,function(c){"touchstart"==c.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");ea=c.type+".iosSliderEvent";m.changeSlide(b,L,I,t,H,B,J,v,T,V,Y,w,R,k,aa,O,n,h)})});""!=h.navPrevSelector&&(a(h.navPrevSelector).css({cursor:"pointer"}),
a(h.navPrevSelector).unbind(ea).bind(ea,function(b){"touchstart"==b.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");ea=b.type+".iosSliderEvent";b=(E[k]+F[k]+O)%O;(0<b||h.infiniteSlider)&&m.changeSlide(b-1,L,I,t,H,B,J,v,T,V,Y,w,R,k,aa,O,n,h)}));""!=h.navNextSelector&&(a(h.navNextSelector).css({cursor:"pointer"}),a(h.navNextSelector).unbind(ea).bind(ea,function(b){"touchstart"==b.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");
ea=b.type+".iosSliderEvent";b=(E[k]+F[k]+O)%O;(b<w.length-1||h.infiniteSlider)&&m.changeSlide(b+1,L,I,t,H,B,J,v,T,V,Y,w,R,k,aa,O,n,h)}));h.autoSlide&&!ha&&""!=h.autoSlideToggleSelector&&(a(h.autoSlideToggleSelector).css({cursor:"pointer"}),a(h.autoSlideToggleSelector).unbind(ea).bind(ea,function(b){"touchstart"==b.type?a(this).unbind("click.iosSliderEvent"):a(this).unbind("touchstart.iosSliderEvent");ea=b.type+".iosSliderEvent";pa?(m.autoSlide(L,I,t,H,B,J,v,T,V,Y,w,R,k,aa,O,n,h),pa=!1,a(h.autoSlideToggleSelector).removeClass("on")):
(m.autoSlidePause(k),pa=!0,a(h.autoSlideToggleSelector).addClass("on"))}));m.autoSlide(L,I,t,H,B,J,v,T,V,Y,w,R,k,aa,O,n,h);a(G).bind("mouseleave.iosSliderEvent",function(){if(pa)return!0;m.autoSlide(L,I,t,H,B,J,v,T,V,Y,w,R,k,aa,O,n,h)});a(G).bind("touchend.iosSliderEvent",function(){if(pa)return!0;m.autoSlide(L,I,t,H,B,J,v,T,V,Y,w,R,k,aa,O,n,h)});h.autoSlideHoverPause&&a(G).bind("mouseenter.iosSliderEvent",function(){m.autoSlidePause(k)});a(G).data("iosslider",{obj:Fa,settings:h,scrollerNode:L,slideNodes:I,
numberOfSlides:O,centeredSlideOffset:n,sliderNumber:k,originalOffsets:Y,childrenOffsets:w,sliderMax:y[k],scrollbarClass:H,scrollbarWidth:B,scrollbarStageWidth:v,stageWidth:J,scrollMargin:T,scrollBorder:V,infiniteSliderOffset:F[k],infiniteSliderWidth:aa,slideNodeOuterWidths:R,shortContent:ha});wa=!1;return!0}b++;var k=b,t=[];U[k]=a.extend({},h);q[k]=0;y[k]=0;var K=[0,0],x=[0,0],S="scrollbarBlock"+b,H="scrollbar"+b,N,W,v,B,p,va,n=0,G=a(this),J,Q,T,V,Ca,wa=!0;g=-1;var w,Y=[],xa=0,ka=0,Ga=0,L=a(this).children(":first-child"),
I,na,R,O=a(L).children().not("script").length,ia=!1,Ea=0,za=!1,sa=void 0,aa;F[k]=0;var ha=!1,pa=!1;oa[k]=!1;var la,ta=!1,qa=!1,ea="touchstart.iosSliderEvent click.iosSliderEvent",fa,ya,Da,ra;ja[k]=!1;X[k]=[];h.scrollbarDrag&&(h.scrollbar=!0,h.scrollbarHide=!1);var Fa=a(this);if(void 0!=Fa.data("iosslider"))return!0;14.2<=parseInt(a().jquery.split(".").join(""),10)?a(this).delegate("img","dragstart.iosSliderEvent",function(a){a.preventDefault()}):a(this).find("img").bind("dragstart.iosSliderEvent",
function(a){a.preventDefault()});h.infiniteSlider&&(h.scrollbar=!1);h.infiniteSlider&&1==O&&(h.infiniteSlider=!1);h.scrollbar&&(""!=h.scrollbarContainer?a(h.scrollbarContainer).append("<div class = '"+S+"'><div class = '"+H+"'></div></div>"):a(L).parent().append("<div class = '"+S+"'><div class = '"+H+"'></div></div>"));if(!C())return!0;a(this).find("a").bind("mousedown",m.preventDrag);a(this).find("[onclick]").bind("click",m.preventDrag).each(function(){a(this).data("onclick",this.onclick)});g=m.calcActiveOffset(h,
m.getSliderOffset(a(L),"x"),w,J,F[k],O,void 0,k);g=(g+F[k]+O)%O;g=new m.args("load",h,L,a(L).children(":eq("+g+")"),g,g);a(G).data("args",g);if(""!=h.onSliderLoaded)h.onSliderLoaded(g);h.scrollbarPaging&&h.scrollbar&&!ha&&(a(W).css("cursor","pointer"),a(W).bind("click.iosSliderEvent",function(b){this==b.target&&(b.pageX>a(N).offset().left?da.nextPage(G):da.prevPage(G))}));if(U[k].responsiveSlides||U[k].responsiveSlideContainer)g=l?"orientationchange":"resize",a(window).bind(g+".iosSliderEvent-"+k,
function(){if(!C())return!0;var b=a(G).data("args");if(""!=h.onSliderResize)h.onSliderResize(b)});!h.keyboardControls&&!h.tabToAdvance||ha||a(document).bind("keydown.iosSliderEvent",function(a){r||u||(a=a.originalEvent);if("INPUT"==a.target.nodeName||ja[k])return!0;if(37==a.keyCode&&h.keyboardControls)a.preventDefault(),a=(E[k]+F[k]+O)%O,(0<a||h.infiniteSlider)&&m.changeSlide(a-1,L,I,t,H,B,J,v,T,V,Y,w,R,k,aa,O,n,h);else if(39==a.keyCode&&h.keyboardControls||9==a.keyCode&&h.tabToAdvance)a.preventDefault(),
a=(E[k]+F[k]+O)%O,(a<w.length-1||h.infiniteSlider)&&m.changeSlide(a+1,L,I,t,H,B,J,v,T,V,Y,w,R,k,aa,O,n,h)});if(e||h.desktopClickDrag){var ma=!1,Aa=!1;g=a(L);var ua=a(L),Ba=!1;h.scrollbarDrag&&(g=g.add(N),ua=ua.add(W));a(g).bind("mousedown.iosSliderEvent touchstart.iosSliderEvent",function(b){a(window).one("scroll.iosSliderEvent",function(a){ma=!1});if(ma)return!0;ma=!0;Aa=!1;"touchstart"==b.type?a(ua).unbind("mousedown.iosSliderEvent"):a(ua).unbind("touchstart.iosSliderEvent");if(ja[k]||ha||(Ba=m.isUnselectable(b.target,
h)))return ia=ma=!1,!0;la=a(this)[0]===a(N)[0]?N:L;r||u||(b=b.originalEvent);m.autoSlidePause(k);ra.unbind(".disableClick");if("touchstart"==b.type)eventX=b.touches[0].pageX,eventY=b.touches[0].pageY;else{if(window.getSelection)window.getSelection().empty?window.getSelection().empty():window.getSelection().removeAllRanges&&window.getSelection().removeAllRanges();else if(document.selection)if(u)try{document.selection.empty()}catch(Ia){}else document.selection.empty();eventX=b.pageX;eventY=b.pageY;
za=!0;sa=L;a(this).css({cursor:P})}K=[0,0];x=[0,0];c=0;ia=!1;for(b=0;b<t.length;b++)clearTimeout(t[b]);b=m.getSliderOffset(L,"x");b>-1*q[k]+n+fa?(b=-1*q[k]+n+fa,m.setSliderOffset(a("."+H),b),a("."+H).css({width:B-V+"px"})):b<-1*y[k]&&(b=-1*y[k],m.setSliderOffset(a("."+H),v-T-B),a("."+H).css({width:B-V+"px"}));b=a(this)[0]===a(N)[0]?q[k]:0;ka=-1*(m.getSliderOffset(this,"x")-eventX-b);m.getSliderOffset(this,"y");K[1]=eventX;x[1]=eventY;qa=!1});a(document).bind("touchmove.iosSliderEvent mousemove.iosSliderEvent",
function(b){r||u||(b=b.originalEvent);if(ja[k]||ha||Ba||!ma)return!0;var e=0;if("touchmove"==b.type)eventX=b.touches[0].pageX,eventY=b.touches[0].pageY;else{if(window.getSelection)window.getSelection().empty||window.getSelection().removeAllRanges&&window.getSelection().removeAllRanges();else if(document.selection)if(u)try{document.selection.empty()}catch(Ja){}else document.selection.empty();eventX=b.pageX;eventY=b.pageY;if(!za||!A&&("undefined"!=typeof b.webkitMovementX||"undefined"!=typeof b.webkitMovementY)&&
0===b.webkitMovementY&&0===b.webkitMovementX)return!0}K[0]=K[1];K[1]=eventX;c=(K[1]-K[0])/2;x[0]=x[1];x[1]=eventY;d=(x[1]-x[0])/2;if(!ia){var g=(E[k]+F[k]+O)%O;g=new m.args("start",h,L,a(L).children(":eq("+g+")"),g,void 0);a(G).data("args",g);if(""!=h.onSlideStart)h.onSlideStart(g)}(d>h.verticalSlideLockThreshold||d<-1*h.verticalSlideLockThreshold)&&"touchmove"==b.type&&!ia&&(ta=!0);(c>h.horizontalSlideLockThreshold||c<-1*h.horizontalSlideLockThreshold)&&"touchmove"==b.type&&b.preventDefault();if(c>
h.slideStartVelocityThreshold||c<-1*h.slideStartVelocityThreshold)ia=!0;if(ia&&!ta){g=m.getSliderOffset(L,"x");var C=a(la)[0]===a(N)[0]?q[k]:n,l=a(la)[0]===a(N)[0]?(q[k]-y[k]-n)/(v-T-B):1,z=a(la)[0]===a(N)[0]?h.scrollbarElasticPullResistance:h.elasticPullResistance,t=h.snapSlideCenter&&a(la)[0]===a(N)[0]?0:n,M=h.snapSlideCenter&&a(la)[0]===a(N)[0]?n:0;"touchmove"==b.type&&(Ga!=b.touches.length&&(ka=-1*g+eventX),Ga=b.touches.length);if(h.infiniteSlider){if(g<=-1*y[k]){var p=a(L).width();if(g<=-1*ca[k]){var D=
-1*Y[0];a(I).each(function(b){m.setSliderOffset(a(I)[b],D+n);b<w.length&&(w[b]=-1*D);D+=R[b]});ka-=-1*w[0];q[k]=-1*w[0]+n;y[k]=q[k]+p-J;F[k]=0}else{var P=0,S=m.getSliderOffset(a(I[0]),"x");a(I).each(function(a){m.getSliderOffset(this,"x")<S&&(S=m.getSliderOffset(this,"x"),P=a)});z=q[k]+p;m.setSliderOffset(a(I)[P],z);q[k]=-1*w[1]+n;y[k]=q[k]+p-J;w.splice(0,1);w.splice(w.length,0,-1*z+n);F[k]++}}if(g>=-1*q[k]||0<=g)if(p=a(L).width(),0<=g)for(D=-1*Y[0],a(I).each(function(b){m.setSliderOffset(a(I)[b],
D+n);b<w.length&&(w[b]=-1*D);D+=R[b]}),ka+=-1*w[0],q[k]=-1*w[0]+n,y[k]=q[k]+p-J,F[k]=O;0<-1*w[0]-p+n;){var W=0,Q=m.getSliderOffset(a(I[0]),"x");a(I).each(function(a){m.getSliderOffset(this,"x")>Q&&(Q=m.getSliderOffset(this,"x"),W=a)});z=q[k]-R[W];m.setSliderOffset(a(I)[W],z);w.splice(0,0,-1*z+n);w.splice(w.length-1,1);q[k]=-1*w[0]+n;y[k]=q[k]+p-J;F[k]--;E[k]++}else W=0,Q=m.getSliderOffset(a(I[0]),"x"),a(I).each(function(a){m.getSliderOffset(this,"x")>Q&&(Q=m.getSliderOffset(this,"x"),W=a)}),z=q[k]-
R[W],m.setSliderOffset(a(I)[W],z),w.splice(0,0,-1*z+n),w.splice(w.length-1,1),q[k]=-1*w[0]+n,y[k]=q[k]+p-J,F[k]--}else p=a(L).width(),g>-1*q[k]+n&&(e=(q[k]+-1*(ka-C-eventX+t)*l-C)*z*-1/l),g<-1*y[k]&&(e=(y[k]+M+-1*(ka-C-eventX)*l-C)*z*-1/l);m.setSliderOffset(L,-1*(ka-C-eventX-e)*l-C+M);h.scrollbar&&(m.showScrollbar(h,H),f=Math.floor((ka-eventX-e-q[k]+t)/(y[k]-q[k]+n)*(v-T-B)*l),g=B,0>=f?(g=B-V- -1*f,m.setSliderOffset(a("."+H),0),a("."+H).css({width:g+"px"})):f>=v-T-V-B?(g=v-T-V-f,m.setSliderOffset(a("."+
H),f),a("."+H).css({width:g+"px"})):m.setSliderOffset(a("."+H),f));"touchmove"==b.type&&(Ca=b.touches[0].pageX);b=!1;e=m.calcActiveOffset(h,-1*(ka-eventX-e),w,J,F[k],O,void 0,k);g=(e+F[k]+O)%O;h.infiniteSlider?g!=ba[k]&&(b=!0):e!=E[k]&&(b=!0);if(b){E[k]=e;ba[k]=g;qa=!0;g=new m.args("change",h,L,a(L).children(":eq("+g+")"),g,g);a(G).data("args",g);if(""!=h.onSlideChange)h.onSlideChange(g);m.updateBackfaceVisibility(I,k,O,h)}}});var Ha=a(window);if(u||r)Ha=a(document);a(g).bind("touchcancel.iosSliderEvent touchend.iosSliderEvent",
function(a){a=a.originalEvent;if(Aa)return!1;Aa=!0;if(ja[k]||ha||Ba)return!0;if(0!=a.touches.length)for(var b=0;b<a.touches.length;b++)a.touches[b].pageX==Ca&&m.slowScrollHorizontal(L,I,t,H,c,d,B,J,v,T,V,Y,w,R,k,aa,O,la,qa,n,h);else m.slowScrollHorizontal(L,I,t,H,c,d,B,J,v,T,V,Y,w,R,k,aa,O,la,qa,n,h);ma=ta=!1;return!0});a(Ha).bind("mouseup.iosSliderEvent-"+k,function(b){ia?ya.unbind("click.disableClick").bind("click.disableClick",m.preventClick):ya.unbind("click.disableClick").bind("click.disableClick",
...
a(this).data("events");if(void 0!=b&&void 0!=b.click&&"iosSliderEvent"!=b.click[0].namespace){if(!ia)return!1;a(this).one("click.disableClick",m.preventClick);b=a(this).data("events").click;var c=b.pop();b.splice(0,0,c)}});if(!oa[k]){if(ha)return!0;h.desktopClickDrag&&a(L).css({cursor:D});h.scrollbarDrag&&a(N).css({cursor:D});za=!1;if(void 0==sa)return!0;m.slowScrollHorizontal(sa,I,t,H,c,d,B,J,v,T,V,Y,w,R,k,aa,O,la,qa,n,h);sa=void 0}ma=ta=!1})}})},destroy:function(b,c){void 0==c&&(c=this);return a(c).each(function(){var c=
...
a(this).data("iosslider");if(void 0==b||b.shortContent)return!1;a(b.scrollerNode).css({cursor:"default"});ja[b.sliderNumber]=!0})},unlock:function(){return this.each(function(){var b=a(this).data("iosslider");if(void 0==b||b.shortContent)return!1;a(b.scrollerNode).css({cursor:D});ja[b.sliderNumber]=!1})},getData:function(){return this.each(function(){var b=a(this).data("iosslider");return void 0==b||b.shortContent?!1:b})},autoSlidePause:function(){return this.each(function(){var b=a(this).data("iosslider");
...
b.bgOverlay||(b.bgOverlay=D("bg").on("click.mfp",function(){b.close()}),b.wrap=D("wrap").attr("tabindex",-1).on("click.mfp",function(a){b._checkIfClose(a.target)&&b.close()}),b.container=D("container",b.wrap));b.contentContainer=D("content");b.st.preloader&&(b.preloader=D("preloader",b.container,b.st.tLoading));h=a.magnificPopup.modules;for(e=0;h.length>e;e++)g=h[e],g=g.charAt(0).toUpperCase()+g.slice(1),b["init"+g].call(b);P("BeforeOpen");b.st.showCloseBtn&&(b.st.closeBtnInside?(x("MarkupParse",
function(a,b,c,d){c.close_replaceWith=W(d.type)}),l+=" mfp-close-btn-in"):b.wrap.append(W()));b.st.alignTop&&(l+=" mfp-align-top");b.fixedContentPos?b.wrap.css({overflow:b.st.overflowY,overflowX:"hidden",overflowY:b.st.overflowY}):b.wrap.css({top:A.scrollTop(),position:"absolute"});(!1===b.st.fixedBgPos||"auto"===b.st.fixedBgPos&&!b.fixedContentPos)&&b.bgOverlay.css({height:f.height(),position:"absolute"});b.st.enableEscapeKey&&f.on("keyup.mfp",function(a){27===a.keyCode&&b.close()});A.on("resize.mfp",
function(){b.updateSize()});b.st.closeOnContentClick||(l+=" mfp-auto-cursor");l&&b.wrap.addClass(l);e=b.wH=A.height();h={};b.fixedContentPos&&b._hasScrollBar(e)&&(g=b._getScrollbarSize())&&(h.marginRight=g);b.fixedContentPos&&(b.isIE7?a("body, html").css("overflow","hidden"):h.overflow="hidden");g=b.st.mainClass;return b.isIE7&&(g+=" mfp-ie7"),g&&b._addClassToMFP(g),b.updateItemHTML(),P("BuildControls"),a("html").css(h),b.bgOverlay.add(b.wrap).prependTo(b.st.prependTo||d),b._lastFocusedEl=document.activeElement,
setTimeout(function(){b.content?(b._addClassToMFP("mfp-ready"),b._setFocus()):b.bgOverlay.addClass("mfp-ready");f.on("focusin.mfp",b._onFocusIn)},16),b.isOpen=!0,b.updateSize(e),P("Open"),c},close:function(){b.isOpen&&(P("BeforeClose"),b.isOpen=!1,b.st.removalDelay&&!b.isLowIE&&b.supportsTransition?(b._addClassToMFP("mfp-removing"),setTimeout(function(){b._close()},b.st.removalDelay)):b._close())},_close:function(){P("Close");var c="mfp-removing mfp-ready ";if(b.bgOverlay.detach(),b.wrap.detach(),
...
b._lastFocusedEl&&a(b._lastFocusedEl).focus();b.currItem=null;b.content=null;b.currTemplate=null;b.prevHeight=0;P("AfterClose")},updateSize:function(a){b.isIOS?(a=document.documentElement.clientWidth/window.innerWidth*window.innerHeight,b.wrap.css("height",a),b.wH=a):b.wH=a||A.height();b.fixedContentPos||b.wrap.css("height",b.wH);P("Resize")},updateItemHTML:function(){var c=b.items[b.index];b.contentContainer.detach();b.content&&b.content.detach();c.parsed||(c=b.parseEl(b.index));var d=c.type;if(P("BeforeChange",
[b.currItem?b.currItem.type:"",d]),b.currItem=c,!b.currTemplate[d]){var f=b.st[d]?b.st[d].markup:!1;P("FirstMarkupParse",f);b.currTemplate[d]=f?a(f):!0}e&&e!==c.type&&b.container.removeClass("mfp-"+e+"-holder");f=b["get"+d.charAt(0).toUpperCase()+d.slice(1)](c,b.currTemplate[d]);b.appendContent(f,d);c.preloaded=!0;P("Change",c);e=c.type;b.container.prepend(b.contentContainer);P("AfterChange")},appendContent:function(a,c){(b.content=a)?b.st.showCloseBtn&&b.st.closeBtnInside&&!0===b.currTemplate[c]?
b.content.find(".mfp-close").length||b.content.append(W()):b.content=a:b.content="";P("BeforeAppend");b.container.addClass("mfp-"+c+"-holder");b.contentContainer.append(b.content)},parseEl:function(c){var d,e=b.items[c];if(e.tagName?e={el:a(e)}:(d=e.type,e={data:e,src:e.src}),e.el){for(var h=b.types,f=0;h.length>f;f++)if(e.el.hasClass("mfp-"+h[f])){d=h[f];break}e.src=e.el.attr("data-mfp-src");e.src||(e.src=e.el.attr("href"))}return e.type=d||b.st.type||"inline",e.index=c,e.parsed=!0,b.items[c]=e,
P("ElementParse",e),b.items[c]},addGroup:function(a,c){var d=function(d){d.mfpEl=this;b._openClick(d,a,c)};c||(c={});c.mainEl=a;c.items?(c.isObj=!0,a.off("click.magnificPopup").on("click.magnificPopup",d)):(c.isObj=!1,c.delegate?a.off("click.magnificPopup").on("click.magnificPopup",c.delegate,d):(c.items=a,a.off("click.magnificPopup").on("click.magnificPopup",d)))},_openClick:function(c,d,e){if((void 0!==e.midClick?e.midClick:a.magnificPopup.defaults.midClick)||2!==c.which&&!c.ctrlKey&&!c.metaKey){var f=
void 0!==e.disableOn?e.disableOn:a.magnificPopup.defaults.disableOn;if(f)if(a.isFunction(f)){if(!f.call(b))return!0}else if(f>A.width())return!0;c.type&&(c.preventDefault(),b.isOpen&&c.stopPropagation());e.el=a(c.mfpEl);e.delegate&&(e.items=d.find(e.delegate));b.open(e)}},updateStatus:function(a,d){b.preloader&&(c!==a&&b.container.removeClass("mfp-s-"+c),d||"loading"!==a||(d=b.st.tLoading),d={status:a,text:d},P("UpdateStatus",d),a=d.status,d=d.text,b.preloader.html(d),b.preloader.find("a").on("click",
function(a){a.stopImmediatePropagation()}),b.container.addClass("mfp-s-"+a),c=a)},_checkIfClose:function(c){if(!a(c).hasClass("mfp-prevent-close")){var d=b.st.closeOnContentClick,e=b.st.closeOnBgClick;if(d&&e||!b.content||a(c).hasClass("mfp-close")||b.preloader&&c===b.preloader[0])return!0;if(c===b.content[0]||a.contains(b.content[0],c)){if(d)return!0}else if(e&&a.contains(document,c))return!0;return!1}},_addClassToMFP:function(a){b.bgOverlay.addClass(a);b.wrap.addClass(a)},_removeClassFromMFP:function(a){this.bgOverlay.removeClass(a);
b.wrap.removeClass(a)},_hasScrollBar:function(a){return(b.isIE7?f.height():document.body.scrollHeight)>(a||A.height())},_setFocus:function(){(b.st.focus?b.content.find(b.st.focus).eq(0):b.wrap).focus()},_onFocusIn:function(c){return c.target===b.wrap[0]||a.contains(b.wrap[0],c.target)?void 0:(b._setFocus(),!1)},_parseMarkup:function(b,c,d){var e;d.data&&(c=a.extend(d.data,c));P("MarkupParse",[b,c,d]);a.each(c,function(a,c){if(void 0===c||!1===c)return!0;if(e=a.split("_"),1<e.length){if(a=b.find(".mfp-"+
e[0]),0<a.length){var d=e[1];"replaceWith"===d?a[0]!==c[0]&&a.replaceWith(c):"img"===d?a.is("img")?a.attr("src",c):a.replaceWith('<img src="'+c+'" class="'+a.attr("class")+'" />'):a.attr(e[1],c)}}else b.find(".mfp-"+a).html(c)})},_getScrollbarSize:function(){if(void 0===b.scrollbarSize){var a=document.createElement("div");a.id="mfp-sbm";a.style.cssText="width: 99px; height: 99px; overflow: scroll; position: absolute; top: -9999px;";document.body.appendChild(a);b.scrollbarSize=a.offsetWidth-a.clientWidth;
document.body.removeChild(a)}return b.scrollbarSize}};a.magnificPopup={instance:null,proto:r.prototype,modules:[],open:function(b,c){return U(),b=b?a.extend(!0,{},b):{},b.isObj=!0,b.index=c||0,this.instance.open(b)},close:function(){return a.magnificPopup.instance&&a.magnificPopup.instance.close()},registerModule:function(b,c){c.options&&(a.magnificPopup.defaults[b]=c.options);a.extend(this.proto,c.proto);this.modules.push(b)},defaults:{disableOn:0,key:null,midClick:!1,mainClass:"",preloader:!0,focus:"",
...
x("Close.inline",function(){F()})},getInline:function(c,d){if(F(),c.src){d=b.st.inline;var e=a(c.src);if(e.length){var f=e[0].parentNode;f&&f.tagName&&(E||(X=d.hiddenClass,E=D(X),X="mfp-"+X),ba=e.after(E).detach().removeClass(X));b.updateStatus("ready")}else b.updateStatus("error",d.tNotFound),e=a("<div>");return c.inlineElement=e,e}return b.updateStatus("ready"),b._parseMarkup(d,{},c),d}}});var q,y=function(){q&&d.removeClass(q);b.req&&b.req.abort()};a.magnificPopup.registerModule("ajax",{options:{settings:null,
cursor:"mfp-ajax-cur",tError:'<a href="%url%">The content</a> could not be loaded.'},proto:{initAjax:function(){b.types.push("ajax");q=b.st.ajax.cursor;x("Close.ajax",y);x("BeforeChange.ajax",y)},getAjax:function(c){q&&d.addClass(q);b.updateStatus("loading");var e=a.extend({url:c.src,success:function(e,f,g){e={data:e,xhr:g};P("ParseAjax",e);b.appendContent(a(e.data),"ajax");c.finished=!0;q&&d.removeClass(q);b._setFocus();setTimeout(function(){b.wrap.addClass("mfp-ready")},16);b.updateStatus("ready");
P("AjaxContentAdded")},error:function(){q&&d.removeClass(q);c.finished=c.loadError=!0;b.updateStatus("error",b.st.ajax.tError.replace("%url%",c.src))}},b.st.ajax.settings);return b.req=a.ajax(e),""}}});var ca,ja=function(c){if(c.data&&void 0!==c.data.title)return c.data.title;var d=b.st.image.titleSrc;if(d){if(a.isFunction(d))return d.call(b,c);if(c.el)return c.el.attr(d)||""}return""};a.magnificPopup.registerModule("image",{options:{markup:'<div class="mfp-figure"><div class="mfp-close"></div><figure><div class="mfp-img"></div><figcaption><div class="mfp-bottom-bar"><div class="mfp-title"></div><div class="mfp-counter"></div></div></figcaption></figure></div>',
cursor:"mfp-zoom-out-cur",titleSrc:"title",verticalFit:!0,tError:'<a href="%url%">The image</a> could not be loaded.'},proto:{initImage:function(){var a=b.st.image;b.types.push("image");x("Open.image",function(){"image"===b.currItem.type&&a.cursor&&d.addClass(a.cursor)});x("Close.image",function(){a.cursor&&d.removeClass(a.cursor);A.off("resize.mfp")});x("Resize.image",b.resizeImage);b.isLowIE&&x("AfterChange",b.resizeImage)},resizeImage:function(){var a=b.currItem;if(a&&a.img&&b.st.image.verticalFit){var c=
0;b.isLowIE&&(c=parseInt(a.img.css("padding-top"),10)+parseInt(a.img.css("padding-bottom"),10));a.img.css("max-height",b.wH-c)}},_onImageHasSize:function(a){a.img&&(a.hasSize=!0,ca&&clearInterval(ca),a.isCheckingImgSize=!1,P("ImageHasSize",a),a.imgHidden&&(b.content&&b.content.removeClass("mfp-loading"),a.imgHidden=!1))},findImageSize:function(a){var c=0,d=a.img[0],e=function(f){ca&&clearInterval(ca);ca=setInterval(function(){return 0<d.naturalWidth?(b._onImageHasSize(a),void 0):(200<c&&clearInterval(ca),
c++,3===c?e(10):40===c?e(50):100===c&&e(500),void 0)},f)};e(1)},getImage:function(c,d){var e=0,f=function(){c&&(c.img[0].complete?(c.img.off(".mfploader"),c===b.currItem&&(b._onImageHasSize(c),b.updateStatus("ready")),c.hasSize=!0,c.loaded=!0,P("ImageLoadComplete")):(e++,200>e?setTimeout(f,100):g()))},g=function(){c&&(c.img.off(".mfploader"),c===b.currItem&&(b._onImageHasSize(c),b.updateStatus("error",h.tError.replace("%url%",c.src))),c.hasSize=!0,c.loaded=!0,c.loadError=!0)},h=b.st.image,l=d.find(".mfp-img");
...
setTimeout(function(){e.remove();a=e=null;P("ZoomAnimationEnded")},16)},f)},16)}});x("BeforeClose.zoom",function(){if(b._allowZoom()){if(clearTimeout(d),b.st.removalDelay=f,!a){if(a=b._getItemToZoom(),!a)return;e=g(a)}e.css(b._getOffset(!0));b.wrap.append(e);b.content.css("visibility","hidden");setTimeout(function(){e.css(b._getOffset())},16)}});x("Close.zoom",function(){b._allowZoom()&&(l(),e&&e.remove(),a=null)})}},_allowZoom:function(){return"image"===b.currItem.type},_getItemToZoom:function(){return b.currItem.hasSize?
...
{};return f.srcAction&&(g[f.srcAction]=e),b._parseMarkup(d,g,c),b.updateStatus("ready"),d}}});var t=function(a){var c=b.items.length;return a>c-1?a-c:0>a?c+a:a},K=function(a,b,c){return a.replace(/%curr%/gi,b+1).replace(/%total%/gi,c)};a.magnificPopup.registerModule("gallery",{options:{enabled:!1,arrowMarkup:'<button title="%title%" type="button" class="mfp-arrow mfp-arrow-%dir%"></button>',preload:[0,2],navigateByImgClick:!0,arrows:!0,tPrev:"Previous (Left arrow key)",tNext:"Next (Right arrow key)",
tCounter:"%curr% of %total%"},proto:{initGallery:function(){var c=b.st.gallery,d=!!a.fn.mfpFastClick;return b.direction=!0,c&&c.enabled?(l+=" mfp-gallery",x("Open.mfp-gallery",function(){c.navigateByImgClick&&b.wrap.on("click.mfp-gallery",".mfp-img",function(){return 1<b.items.length?(b.next(),!1):void 0});f.on("keydown.mfp-gallery",function(a){37===a.keyCode?b.prev():39===a.keyCode&&b.next()})}),x("UpdateStatus.mfp-gallery",function(a,c){c.text&&(c.text=K(c.text,b.currItem.index,b.items.length))}),
x("MarkupParse.mfp-gallery",function(a,d,e,f){a=b.items.length;e.counter=1<a?K(c.tCounter,f.index,a):""}),x("BuildControls.mfp-gallery",function(){if(1<b.items.length&&c.arrows&&!b.arrowLeft){var e=c.arrowMarkup,f=b.arrowLeft=a(e.replace(/%title%/gi,c.tPrev).replace(/%dir%/gi,"left")).addClass("mfp-prevent-close");e=b.arrowRight=a(e.replace(/%title%/gi,c.tNext).replace(/%dir%/gi,"right")).addClass("mfp-prevent-close");var g=d?"mfpFastClick":"click";f[g](function(){b.prev()});e[g](function(){b.next()});
b.isIE7&&(D("b",f[0],!1,!0),D("a",f[0],!1,!0),D("b",e[0],!1,!0),D("a",e[0],!1,!0));b.container.append(f.add(e))}}),x("Change.mfp-gallery",function(){b._preloadTimeout&&clearTimeout(b._preloadTimeout);b._preloadTimeout=setTimeout(function(){b.preloadNearbyImages();b._preloadTimeout=null},16)}),x("Close.mfp-gallery",function(){f.off(".mfp-gallery");b.wrap.off("click.mfp-gallery");b.arrowLeft&&d&&b.arrowLeft.add(b.arrowRight).destroyMfpFastClick();b.arrowRight=b.arrowLeft=null}),void 0):!1},next:function(){b.direction=
...
d.parsed||(d=b.parseEl(c));P("LazyLoad",d);"image"===d.type&&(d.img=a('<img class="mfp-img" />').on("load.mfploader",function(){d.hasSize=!0}).on("error.mfploader",function(){d.hasSize=!0;d.loadError=!0;P("LazyLoadError",d)}).attr("src",d.src));d.preloaded=!0}}}});a.magnificPopup.registerModule("retina",{options:{replaceSrc:function(a){return a.src.replace(/\.\w+$/,function(a){return"@2x"+a})},ratio:1},proto:{initRetina:function(){if(1<window.devicePixelRatio){var a=b.st.retina,c=a.ratio;c=isNaN(c)?
c():c;1<c&&(x("ImageHasSize.retina",function(a,b){b.img.css({"max-width":b.img[0].naturalWidth/c,width:"100%"})}),x("ElementParse.retina",function(b,d){d.src=a.replaceSrc(d,c)}))}}}});(function(){var b="ontouchstart"in window,c=function(){A.off("touchmove"+d+" touchend"+d)},d=".mfpFastClick";a.fn.mfpFastClick=function(e){return a(this).each(function(){var f,g=a(this);if(b){var h,l,k,m,r,u;g.on("touchstart"+d,function(a){m=!1;u=1;r=a.originalEvent?a.originalEvent.touches[0]:a.touches[0];l=r.clientX;
k=r.clientY;A.on("touchmove"+d,function(a){r=a.originalEvent?a.originalEvent.touches:a.touches;u=r.length;r=r[0];(10<Math.abs(r.clientX-l)||10<Math.abs(r.clientY-k))&&(m=!0,c())}).on("touchend"+d,function(a){c();m||1<u||(f=!0,a.preventDefault(),clearTimeout(h),h=setTimeout(function(){f=!1},1E3),e())})})}g.on("click"+d,function(){f||e()})})};a.fn.destroyMfpFastClick=function(){a(this).off("touchstart"+d+" click"+d);b&&A.off("touchmove"+d+" touchend"+d)}})();U()})(window.jQuery||window.Zepto);
...
if(""==this.value){if("password"==this.type){if(!a.data("placeholder-textinput")){try{var e=a.clone().attr({type:"text"})}catch(U){e=c("<input>").attr(c.extend(d(this),{type:"text"}))}e.removeAttr("name").data({"placeholder-password":a,"placeholder-id":b}).bind("focus.placeholder",f);a.data({"placeholder-textinput":e,"placeholder-id":b}).before(e)}a=a.removeAttr("id").hide().prev().attr("id",b).show()}a.addClass("placeholder");a[0].value=a.attr("placeholder")}else a.removeClass("placeholder")}function l(){try{return b.activeElement}catch(D){}}
var g="placeholder"in b.createElement("input"),r="placeholder"in b.createElement("textarea"),u=c.fn,A=c.valHooks,x=c.propHooks;g&&r?(u=u.placeholder=function(){return this},u.input=u.textarea=!0):(u=u.placeholder=function(){this.filter((g?"textarea":":input")+"[placeholder]").not(".placeholder").bind({"focus.placeholder":f,"blur.placeholder":e}).data("placeholder-enabled",!0).trigger("blur.placeholder");return this},u.input=g,u.textarea=r,u={get:function(a){var b=c(a),d=b.data("placeholder-password");
return d?d[0].value:b.data("placeholder-enabled")&&b.hasClass("placeholder")?"":a.value},set:function(a,b){var d=c(a),g=d.data("placeholder-password");if(g)return g[0].value=b;if(!d.data("placeholder-enabled"))return a.value=b;""==b?(a.value=b,a!=l()&&e.call(a)):d.hasClass("placeholder")?f.call(a,!0,b)||(a.value=b):a.value=b;return d}},g||(A.input=u,x.value=u),r||(A.textarea=u,x.value=u),c(function(){c(b).delegate("form","submit.placeholder",function(){var a=c(".placeholder",this).each(f);setTimeout(function(){a.each(e)},
...
a.parent().children("ul").hide()):(c=b.siblings(),c.removeClass(tdMenu._openMenuClass),c.find("ul").hide(),c.find("li").removeClass(tdMenu._openMenuClass)),b.addClass(tdMenu._openMenuClass),b.children("ul").show(),tdMenu._getSubmenuPosition(b),d.addClass(tdMenu._openMenuBodyClass))});else{var c={},d,f=!0;b.on("mouseleave",function(){a.parent().removeClass(tdMenu._openMenuClass);a.parent().children("ul").hide();c={}});b.find(".menu-item").hover(function(){var b=jQuery(this),l="",g,r;if(b.hasClass("menu-item-has-children")||
b.hasClass("td-mega-menu"))if(b.parent().hasClass("sf-menu"))if(jQuery.isEmptyObject(c))b.addClass(tdMenu._openMenuClass),b.children("ul").show(),c=b;else{if(b[0]!==c[0]){var u=r=g=0;var A=null;!0===f&&(f=!1,d=setTimeout(function(){a.parent().removeClass(tdMenu._openMenuClass);a.parent().children("ul").hide();b.addClass(tdMenu._openMenuClass);b.children("ul").show();c=b},400));b.on("mousemove",function(e){5<=g?(g=0,A=tdMenu._getMouseAngleDirection(r,u,e.pageX,e.pageY),r=e.pageX,u=e.pageY):(g++,0===
r&&0===u&&(r=e.pageX,u=e.pageY));null!==A&&(85<A||-85>A)&&(a.parent().removeClass(tdMenu._openMenuClass),a.parent().children("ul").hide(),b.addClass(tdMenu._openMenuClass),b.children("ul").show(),b.off("mousemove"),clearTimeout(d),f=!0,c=b)})}}else l=b.siblings(),l.removeClass(tdMenu._openMenuClass),l.find("ul").hide(),l.find("li").removeClass(tdMenu._openMenuClass),b.addClass(tdMenu._openMenuClass),b.children("ul").show(),tdMenu._getSubmenuPosition(b);else b.parent().hasClass("sf-menu")||b.parent().hasClass("top-header-menu")?
jQuery.isEmptyObject(c)||(u=r=g=0,A=null,!0===f&&(f=!1,d=setTimeout(function(){a.parent().removeClass(tdMenu._openMenuClass);a.parent().children("ul").hide();c={}},400)),b.on("mousemove",function(e){5<=g?(g=0,A=tdMenu._getMouseAngleDirection(r,u,e.pageX,e.pageY),r=e.pageX,u=e.pageY):(g++,0===r&&0===u&&(r=e.pageX,u=e.pageY));null!==A&&(85<A||-85>A)&&(a.parent().removeClass(tdMenu._openMenuClass),a.parent().children("ul").hide(),b.off("mousemove"),clearTimeout(d),f=!0,c={})})):(c=b.parent(),l=b.siblings(),
...
a)?g.sidebar_state="case_4_fixed_up":"up"===d&&!0===tdSmartSidebar._is_smaller_or_equal(e,g.sidebar_top)&&(g.sidebar_state="case_2_top_of_content"),"case_1_fixed_down"===g.sidebar_state&&"up"===d||"case_4_fixed_up"===g.sidebar_state&&"down"===d)g.sidebar_state="case_5_absolute";r=0;null!==tdViewport.getCurrentIntervalItem()&&(r=g.sidebar_jquery_obj.parent(".vc_column, .td-main-sidebar, .vc_column-inner, .vc_column_inner").width(),g.sidebar_jquery_obj.width(r));switch(g.sidebar_state){case "case_1_fixed_down":if(!0===
g.case_1_run_once)break;tdSmartSidebar.log("sidebar_id: "+l+" "+g.sidebar_state);g.case_1_run_once=!0;g.case_2_run_once=!1;g.case_3_run_once=!1;g.case_4_run_once=!1;g.case_5_run_once=!1;g.case_6_run_once=!1;g.sidebar_jquery_obj.css({width:r,position:"fixed",top:"auto",bottom:"0","z-index":"1"});break;case "case_2_top_of_content":if(!0===g.case_2_run_once)break;tdSmartSidebar.log("sidebar_id: "+l+" "+g.sidebar_state);g.case_1_run_once=!1;g.case_2_run_once=!0;g.case_3_run_once=!1;g.case_4_run_once=
...
g.case_4_run_once=!1;g.case_5_run_once=!1;g.case_6_run_once=!1;g.sidebar_jquery_obj.css({width:r,position:"absolute",top:g.content_bottom-g.sidebar_height-g.content_top,bottom:"auto"});break;case "case_4_fixed_up":if(!0===g.case_4_run_once&&g.case_4_last_menu_offset===b)break;tdSmartSidebar.log("sidebar_id: "+l+" "+g.sidebar_state);g.case_1_run_once=!1;g.case_2_run_once=!1;g.case_3_run_once=!1;g.case_4_run_once=!0;g.case_4_last_menu_offset=b;g.case_5_run_once=!1;g.case_6_run_once=!1;g.sidebar_jquery_obj.css({width:r,
...
var Froogaloop=function(){function a(b){return new a.fn.init(b)}function b(a,b,c){if(!c.contentWindow.postMessage)return!1;var d=c.getAttribute("src").split("?")[0];a=JSON.stringify({method:a,value:b});"//"===d.substr(0,2)&&(d=window.location.protocol+d);c.contentWindow.postMessage(a,d)}function c(a){try{var b=JSON.parse(a.data);var c=b.event||b.method}catch(D){}"ready"==c&&!e&&(e=!0);if(a.origin!=l)return!1;a=b.value;var d=b.data,g=""===g?null:b.player_id;b=g?f[g][c]:f[c];c=[];if(!b)return!1;void 0!==
