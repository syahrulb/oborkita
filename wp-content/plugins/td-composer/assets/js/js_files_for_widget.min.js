...
a.on("click",".tdc-property-editor_css .tdc-property-title",function(a){tdcSidebarPanel.showHideTdcCssEditor.call(this,a)});a.on("click",".tdc-property-flex_layout label",function(a){a=jQuery(this);var b=jQuery(".tdc-property-flex_horiz_align"),c=jQuery(".tdc-property-flex_vert_align"),d=jQuery(".tdc-property-flex_layout_reverse");"Row"===a.attr("title")?(b.hasClass("tdc-flex-row-align-rev")||b.addClass("tdc-flex-row-align-rev"),c.hasClass("tdc-flex-row-align-rev")||c.addClass("tdc-flex-row-align-rev"),
d.find("input").is(":checked")&&(b.hasClass("tdc-flex-row-rev-align-rev")||b.addClass("tdc-flex-row-rev-align-rev"))):(b.hasClass("tdc-flex-row-align-rev")&&b.removeClass("tdc-flex-row-align-rev"),c.hasClass("tdc-flex-row-align-rev")&&c.removeClass("tdc-flex-row-align-rev"),b.hasClass("tdc-flex-row-rev-align-rev")&&b.removeClass("tdc-flex-row-rev-align-rev"))});a.on("change",".tdc-property-flex_layout_reverse input",function(a){a=jQuery(this);var b=jQuery(".tdc-property-flex_layout .tdc-property-input-radio:checked"),
c=jQuery(".tdc-property-flex_horiz_align");"column"===b.val()&&(a.is(":checked")?c.hasClass("tdc-flex-row-rev-align-rev")||c.addClass("tdc-flex-row-rev-align-rev"):c.hasClass("tdc-flex-row-rev-align-rev")&&c.removeClass("tdc-flex-row-rev-align-rev"))});a.on("mousedown",function(a){var b=jQuery("#tdc-sidebar"),c=jQuery("#tdc-icon-selector"),d=jQuery("#tdc-gradient"),f=jQuery("#tdc-palette"),g=jQuery("#tdc-font-list"),l=jQuery(".tdc-preset-values-list");c.length?c.get(0).contains(a.target)||(c.hide(),
b.after(c)):c=tdcSidebar.buildIconSelector();d.length?d.get(0).contains(a.target)||(c=jQuery(a.target),c.hasClass("tdc-gradient-wrap")||(d.hide(),b.after(d))):d=tdcSidebar.buildGradient();f.length?f.get(0).contains(a.target)||(c=jQuery(a.target),c.hasClass("tdc-colorpicker-wrap")||(f.hide(),b.after(f),f.find("input.wp-color-picker").tdPaletteColorPicker("save_color"))):f=tdcSidebar.buildPalette();g.length&&!g.get(0).contains(a.target)&&(g.hide(),b.after(g));!l.length||l.get(0).contains(a.target)||
...
c){_.isUndefined(c)&&(c=jQuery(a.currentTarget).data("model_id"),c=tdcIFrameData.getModel(c),a={error:k},_.isUndefined(c)||tdcIFrameData._checkModelData(c,a));var b=c.get("tag");c=c.get("attrs");c=_.clone(c);if(!_.isUndefined(c)){var e={};a={};for(var d in c)0===d.indexOf("tds_")&&(e[d]=c[d]);d=window.tdcAdminSettings.mappedShortcodes[b].params;for(b=0;b<d.length;b++){var f=!1,g=d[b];if(0===g.param_name.indexOf("tds_")){for(var l in e)if(g.param_name===l){a[l]=e[l];f=!0;break}f||(a[g.param_name]=
"")}}for(l in e)switch(e=l.split("-"),e.length){case 2:if(!_.has(a,l)){d=e[0];e=!1;for(var n in a)if(d===a[n]&&1===n.split("-").length){e=!0;break}if(!e){var h;for(h in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[h],d)){var m=h;break}_.has(a,m)&&""===a[m]&&window.tdcAdminSettings.globalStyle[m]===d&&(e=!0)}e||delete c[l]}break;case 3:d=e[0];b=e[2];for(h in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[h],d)){m=h;break}e=
!1;for(n in a)if(d===a[n]&&n===m+"-"+b){e=!0;break}e||_.has(a,m+"-"+b)&&""===a[m+"-"+b]&&window.tdcAdminSettings.globalStyle[m]===d&&(e=!0);e||delete c[l]}return c}},getCurrentListAtts:function(a,c,b){_.isUndefined(c)&&(a=jQuery(a.currentTarget).data("model_id"),c=tdcIFrameData.getModel(a),a={error:k},_.isUndefined(c)||tdcIFrameData._checkModelData(c,a));a=c.get("tag");c=c.get("attrs");var e=_.clone(c);if(!_.isUndefined(e)){var d={};c={};for(var f in e)0===f.indexOf("tds_")&&(d[f]=e[f]);f=window.tdcAdminSettings.mappedShortcodes[a].params;
for(var g=0;g<f.length;g++){var l=!1,n=f[g];if(0===n.param_name.indexOf("tds_")){for(var h in d)if(n.param_name===h){c[h]=d[h];l=!0;break}l||(c[n.param_name]="")}}for(h in d)switch(d=h.split("-"),d.length){case 2:if(!_.has(c,h)){f=d[0];d=!1;for(var m in c)if(f===c[m]&&1===m.split("-").length){d=!0;break}if(!d){var q;for(q in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[q],f)){var p=q;break}_.has(c,p)&&""===c[p]&&window.tdcAdminSettings.globalStyle[p]===f&&(d=
!0)}d||delete e[h]}break;case 3:f=d[0];l=d[2];for(q in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[q],f)){p=q;break}d=!1;for(m in c)if(f===c[m]&&m===p+"-"+l){d=!0;break}d||_.has(c,p+"-"+l)&&""===c[p+"-"+l]&&window.tdcAdminSettings.globalStyle[p]===f&&(d=!0);d||delete e[h]}var u=[],v;for(v in window.tdcAdminSettings.listStyles[b])if(v===a){for(g=0;g<window.tdcAdminSettings.listStyles[b][v].length;g++)h=window.tdcAdminSettings.listStyles[b][v][g],_.isArray(h)?
_.map(h,function(a){_.isUndefined(e[a])||(_.isUndefined(u[g])&&(u[g]=[]),u[g].push(e[a]))}):_.isUndefined(e[h])||(_.isArray(e[h])&&e[h].length?u[g]=e[h][0]:u[g]=e[h]);break}return u}},showHideTdcCssEditor:function(a){a=jQuery("#tdc-editor-css");var c=jQuery(this).closest(".tdc-property-wrap"),b=c.find("textarea:first");a.length||tdcSidebar.buildEditorCss();tdcSidebar.$editorTextarea=b;c.next("#tdc-editor-css").length?a.toggle():(c.after(a),a.show(),tdcSidebar.editorCss.getSession().setValue(b.val()))},
showHideTdcPalette:function(a){a=jQuery("#tdc-palette");var c=jQuery(this).closest(".tdc-property-wrap");a.length||tdcSidebar.buildPalette();c.next("#tdc-palette").length?(a.toggle(),tdcSidebarPanel.saveTdcPalette()):(tdcSidebarPanel.saveTdcPalette(),c.after(a),a.show(),tdcSidebarPanel.openTdcPalette())},saveTdcPalette:function(){var a=jQuery("#tdc-palette"),c=a.prev(".tdc-property-wrap");a.length||tdcSidebar.buildPalette();c.length&&(c=c.find("input").val(),a=a.find("input.wp-color-picker"),a.tdPaletteColorPicker("open_palette",
c),a.tdPaletteColorPicker("save_color"))},openTdcPalette:function(){var a=jQuery("#tdc-palette"),c=a.prev(".tdc-property-wrap");a.length||tdcSidebar.buildPalette();c.length&&(c=c.find("input").val(),a.find("input.wp-color-picker").tdPaletteColorPicker("open_palette",c))},tdcIconWrapHandler:function(a){var c=jQuery(this),b=jQuery("#tdc-icon-selector");b.length||(b=tdcSidebar.buildIconSelector());var e=c.closest(".tdc-property-wrap");a=b.find(".tdc-icon-selector-filter");var d=b.find(".tdc-icon-selector-lib"),
...
1);tdcUtil.updateTdcSavings()})});jQuery(".tdc-breadcrumbs").show();0<tdcSidebarPanel.$_paramNameSwitch.length&&(tdcSidebarPanel.$_paramNameSwitch.show(),tdcSidebarPanel.$_paramNameSwitch.hasClass("tdc-param-name-switch-active")&&jQuery(".tdc-param-name").addClass("tdc-param-name-active"));tdcSidebarPanel._hook.doAction("panel_rendered");tdcSidebarPanel._hook.doAction("panel_css");(function(){if("vc_row"===a.get("tag")){var b=jQuery("body .tdc-row-col-dropdown select"),c=jQuery("body .tdc-row-stretch-dropdown select"),
...
b.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col");break;case "23":b.parent().find("input[value=12_12] + label").removeClass("tdc-block-col"),b.parent().find("input[value=23_13] + label").addClass("tdc-block-col"),b.parent().find("input[value=13_23] + label").addClass("tdc-block-col"),b.parent().find("input[value=13_13_13] + label").addClass("tdc-block-col")}}}})();(function(){var b=a.get("tag");if("vc_row"===b||"vc_row_inner"===b||"vc_column"===b||"vc_column_inner"===b){b=
jQuery("body .tdc-property-flex_layout");var c=a.get("childCollection");if(!_.isUndefined(c)&&b.length){c=jQuery("body .tdc-property-flex_horiz_align");var d=jQuery("body .tdc-property-flex_vert_align"),e=jQuery("body .tdc-property-flex_layout_reverse");b.find("input[value=column]").is(":checked")&&(c.addClass("tdc-flex-row-align-rev"),d.addClass("tdc-flex-row-align-rev"),e.find("input").is(":checked")&&c.addClass("tdc-flex-row-rev-align-rev"))}}})()}},_bindGroupAndGetHtml:function(a,c,b){var e="",
d=b.get("attrs");if("tdc_zone"===b.get("tag"))var f=d.type;for(var g=0;g<c.params.length;g++){var l=c.params[g].param_name,n=c.params[g].group;if(a===tdcSidebarPanel._defaultGroupName&&_.isEmpty(c.params[g].group)||c.params[g].group===a){if(!_.isUndefined(f)&&(!_.isUndefined(c.params[g].zone_group)&&f!==c.params[g].zone_group||"type"===l))continue;e+=tdcSidebarPanel._bindParamAndGetHtml(c.params[g],b)}if("block_template_id"===l){n=d.block_template_id;_.isEmpty(n)&&(n=window.tdcAdminSettings.globalBlockTemplate);
...
_.isObject(a.value[g[l]])&&(k=!0,u=_.values(a.value[g[l]])[0],q=_.keys(a.value[g[l]])[0]);b||e?(0===l&&""===p&&(p=u),p===u&&(h=" checked "),m=_.uniqueId(),p=u,"vc_row"!==c.attributes.tag&&"vc_row_inner"!==c.attributes.tag||-1!==a.param_name.indexOf("flex_")||(p="col_"+p),f+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+m+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+h+' value="'+u+'">',b?(h="",k&&(h="tdc-standard-value"),f+='<label class="tdc-property-input-radio-label '+
h+'" for="'+m+'" title="'+q+'"><div class="'+p+'"></div></label>'):f+='<label class="tdc-property-input-radio-label" for="'+m+'" title="'+q+'">'+u+"</label>"):(p===u&&(h=' selected="selected" '),"__"===u&&-1!==q.search("--")&&(m=" disabled "),f+="<option "+h+" "+m+' value="'+u+'">'+q+"</option>")}g="";_.has(a,"description")&&""!==a.description&&(g=' title="'+a.description+'" ');d+='<div class="'+tdcSidebarPanel._getParameterClasses(a)+'">';d+='<div class="tdc-property-title"><span class="tdc-search-data"'+
...
if(b||e){0===h&&""===k&&(k=u);k===u&&(q=" checked ");var v=_.uniqueId(),r=u;"vc_row"!==c.attributes.tag&&"vc_row_inner"!==c.attributes.tag||-1!==a.param_name.indexOf("flex_")||(r="col_"+r);f+='<input class="tdc-property-input-radio" type="radio" '+tdcSidebarPanel._getParamterDataAtts(a,c)+' id="'+v+'" name="'+tdcSidebarPanel._getParameterDomName(a)+'" '+q+' value="'+u+'" '+l+">";b?(q="",m&&(q="tdc-standard-value"),f+='<label class="tdc-property-input-radio-label '+q+'" for="'+v+'" title="'+p+'"><div class="'+
r+'"></div></label>'):f+='<label class="tdc-property-input-radio-label" for="'+v+'" title="'+p+'">'+u+"</label>"}else k===u&&(q=' selected="selected" '),f+="<option "+q+' value="'+u+'">'+p+"</option>"}g="";_.has(a,"description")&&""!==a.description&&(g=' title="'+a.description+'" ');d+='<div class="tdc-property-responsive '+tdcSidebarPanel._getParameterClasses(a)+'">';d+='<div class="tdc-property-title"><span class="tdc-search-data"'+g+">"+a.heading+'<div title="Revert to desktop settings" class="tdc-inherit tdc-inherit-select" style="display: block;"></div></span></div>';
